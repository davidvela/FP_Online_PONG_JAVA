...
public class MainServer extends JFrame 
{
   ...
   public ServerSocket createGameStreamSocket (int num_players)
   {
        try // set up server to receive connections; process connections
        {
            //ServerSocket ( port , backlog)
            ServerSocket server = new ServerSocket( serverPort_tcp, num_players ); 
            return server;             
        }   
           ...
           // displayMessage(buffer);
            ...
            switch (type_pck)
            {
                ...
                case NEW_GAME:
                    ...
                    ServerSocket server = createGameStreamSocket
